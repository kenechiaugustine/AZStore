    ...
    <>
      <section className={styles.main}>
        ...
        <div className={styles.SearchContainer}>
          <select className={styles.SearchSelection} id="search_selection" name="search_selection">
          ...
          <input className={styles.SearchInput} placeholder="Search Amazon" type="text" name="searchButton" id="searchButton" />
        ...
        <div>
          {/* <img color="white" src="/next.svg" alt="" /> */}
          <span>EN</span>
        </div>
